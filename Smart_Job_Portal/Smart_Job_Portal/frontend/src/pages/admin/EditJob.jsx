    ...
    useEffect(() => {
        const fetchJob = async () => {
            try {
                ...
                const formattedDate = data.application_last_date
                    ? new Date(data.application_last_date).toISOString().split('T')[0]
                    : '';
                ...
                setFormData({
                    ...
                    application_last_date: formattedDate,
        ...
        <div className="min-h-[calc(100vh-5rem)] bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex justify-center animate-fade-in relative overflow-hidden">
            ...
            <div className="max-w-2xl w-full relative z-10">
                <div className="mb-8 pl-2">
                    ...
                    <p className="mt-2 text-gray-600 font-medium">Update the details for your job posting below.</p>
                </div>
